            ...
            <div class="min-w-[20rem]">
              <div class="text-right mb-4">
                <Link
                  ...
                  :href="route('tipos-links.edit', tiposLink.id)"
                >
                  Editar
                </Link>
                /
                <Link :preserveState="true" :preserveScroll="true"
                  @click="doConfirmDeleteVisible(tiposLink.id, tiposLink.descripcion)" class="text-red-700"
                  >Borrar</Link
                >
              </div>
              ...
              <div class="table w-full">
                ...
                <div v-if="tiposLink.deleted_at" class="table-row">
...
const { tiposLink } = toRefs(props)

const created_at = computed(() => {
  return formatDatetime(tiposLink.value.created_at)
})

const updated_at = computed(() => {
  return formatDatetime(tiposLink.value.updated_at)
})
